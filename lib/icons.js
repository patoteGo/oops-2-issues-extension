/**
 * BugSnap icon set (Lucide-style, stroke-based, currentColor).
 * Each value is a full <svg> string. Inject with el.innerHTML = icons.name.
 * Keep stroke-width consistent for an elegant, cohesive look.
 */
const svg = inner =>
...
export const icons = {
  ...
  listChecks: svg(
    '<path d="M3 5h4"/><path d="M3 12h4"/><path d="M3 19h4"/><path d="M7 5l1 1 2-2"/><path d="M7 12l1 1 2-2"/><path d="M7 19l1 1 2-2"/><path d="M12 6h9"/><path d="M12 13h9"/><path d="M12 20h9"/>'
  ),
  ...
  // Markdown toolbar glyphs (all stroke-based)
  ...
  // Reference attachments (drag & drop + browse)
  upload: svg(
