/**
 * BugSnap side panel controller — entry point + cross-cutting wiring.
 *
...
function wireStaticIcons() {
  ...
  fill(el.refreshProjects, 'refresh')
...
function bindEvents() {
  ...
  el.project.addEventListener('change', saveDraft)
